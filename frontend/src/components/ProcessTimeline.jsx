      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="space-y-24">
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className={`flex flex-col md:flex-row gap-12 items-center ${isEven ? '' : 'md:flex-row-reverse'}`} data-aos="fade-up">
                ...
                <div className="w-full md:w-1/2 flex gap-6 md:gap-10">
                  ...
                  <div className="flex-1 pt-4 border-t border-luxury-sand">
                    ...
                    <h3 className="font-heading text-3xl text-luxury-navy mb-4">{step.title}</h3>
                    <p className="text-luxury-taupe text-lg leading-relaxed">{step.desc}</p>
                  </div>
                </div>
